    ...
    class SignInRequestThread extends Thread {
        ...
        public void run() {
            ...
            try {
               ...
               //Get 방식
                URL url = new URL(String.format("http://172.16.6.23:8087/bikelong/account/msignin.action?id="+id+"&password="+password));// URL클래스의 생성자로 주소를 넘겨준다.
                ...
                if (responseCode == 200) { // 정상 응답일 경우
                        ...
                        if (result) {
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    finish();
                                    Intent userMainIntent = new Intent(SignInActivity.this, UserMainActivity.class);
                                    userMainIntent.putExtra("member", member);
